...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link href="{{ asset('frontend/assets/css/animate.css') }}assets/css/animate.css" rel="stylesheet" media="screen">
                ...
                <div class="row">
                    <div class="proerty-th">
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-1.html" ><img src="{{ asset('frontend/assets/img/demo/property-1.jpg') }}"></a>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-2.html" ><img src="{{ asset('frontend/assets/img/demo/property-2.jpg') }}"></a>
                                </div>
                                <div class="item-entry overflow">
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-3.html" ><img src="{{ asset('frontend/assets/img/demo/property-3.jpg') }}"></a>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-1.html" ><img src="{{ asset('frontend/assets/img/demo/property-4.jpg') }}"></a>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-3.html" ><img src="{{ asset('frontend/assets/img/demo/property-2.jpg') }}"></a>
                                </div>
                                <div class="item-entry overflow">
                                    <h5><a href="property-3.html" >Super nice villa </a></h5>
                                    <div class="dot-hr"></div>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-2.html" ><img src="{{ asset('frontend/assets/img/demo/property-4.jpg') }}"></a>
                                </div>
                                <div class="item-entry overflow">
                                    <h5><a href="property-2.html" >Super nice villa </a></h5>
                                    <div class="dot-hr"></div>
                        ...
                        <div class="col-sm-6 col-md-3 p0">
                            <div class="box-two proerty-item">
                                <div class="item-thumb">
                                    <a href="property-1.html" ><img src="{{ asset('frontend/assets/img/demo/property-3.jpg') }}"></a>
                                </div>
                                <div class="item-entry overflow">
                                    <h5><a href="property-1.html" >Super nice villa </a></h5>
                                    <div class="dot-hr"></div>
                            ...
                            <div id="testimonial-slider">
                                <div class="item">
                                    ...
                                    <div class="client-face wow fadeInRight" data-wow-delay=".9s"> 
                                        <img src="{{ asset('frontend/assets/img/client-face1.png') }}" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="client-text">                                
                                    ...
                                    <div class="client-face">
                                        <img src="{{ asset('frontend/assets/img/client-face2.png') }}" alt="">
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="client-text">                                
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <img src="{{ asset('frontend/assets/img/footer-logo.png') }}" alt="" class="wow pulse" data-wow-delay="1s">
                                ...
                                <ul class="footer-blog">
                                    <li>
                                        <div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="single.html">
                                                <img src="{{ asset('frontend/assets/img/demo/small-proerty-2.jpg ') }}">
                                            </a>
