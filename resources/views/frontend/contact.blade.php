            ...
            <div class="container py-5">
                ...
                <div class="row g-5 mb-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".5s">
						<p class="mb-4">For any questions, reviews, or business inquiries, Let's contact us!</a>.</p>
                        <div class="rounded contact-form">
                            <form action="{{ route('save-message') }}" enctype="multipart/form-data" method="post">
                                @csrf
                            <div class="mb-4">
                                <input type="text" class="form-control p-3" placeholder="Subject" name="nama"  value=" {{ auth()->user()->nama }}"  >
                            </div>
                            <div class="mb-4">
                                <input type="text" class="form-control p-3" placeholder="Subject" name="email"  value=" {{ auth()->user()->email }}"  >
                            </div>
                            <div class="mb-4">
                                <input type="text" class="form-control p-3" placeholder="Subject" name="subject">
                            </div>
                            <div class="mb-4">
                                <textarea class="w-100 form-control p-3" rows="6" cols="10" placeholder="Message" name="messages"></textarea>
                            </div>
                            <button class="btn btn-primary border-0 py-3 px-4 rounded-pill" type="submit" onclick="window.location='{{ route('save-message') }}'">Send Message</button>
                        </form>
                        </div>
                    </div>
                </div>
