                            ...
                            <div class="panel-body recent-property-widget">
                                        ...
                                        <li>
                                            <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                                <a href="single.html"><img src="  {{ asset('frontend/assets/img/demo/small-property-2.jpg') }}"></a>
                                        ...
                                        <li>
                                            <div class="col-md-3 col-sm-3  col-xs-3 blg-thumb p0">
                                                <a href="single.html"><img src="  {{ asset('frontend/assets/img/demo/small-property-1.jpg') }}"></a>
                                                <span class="property-seeker">
                                                    <b class="b-1">A</b>
                                                    <b class="b-2">S</b>
                                                </span>
                                        ...
                                        <li>
                                            <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                                <a href="single.html"><img src="  {{ asset('frontend/assets/img/demo/small-property-3.jpg') }}"></a>
                                                <span class="property-seeker">
                                                    <b class="b-1">A</b>
                                                    <b class="b-2">S</b>
                                                </span>
                        ...
                        <div id="list-type" class="proerty-th">
                            <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        ...
                                        <div class="item-entry overflow">
                                            ...
                                            <div class="property-icon">
                                                <img src="  {{ asset('frontend/assets/img/icon/bed.png') }}">(5)|
                                                <img src="  {{ asset('frontend/assets/img/icon/shawer.png') }}">(2)|
                                                <img src="  {{ asset('frontend/assets/img/icon/cars.png') }}">(1)  
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6 col-md-4 p0">
                                    <div class="box-two proerty-item">
                                        <div class="item-thumb">
                                            <a href="property-1.html" ><img src="  {{ asset('frontend/assets/img/demo/property-2.jpg') }}"></a>
                                        </div>
