<div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">MaidCompany</span>
    </a>
  ...
  <ul class="menu-inner py-1">
   ...
   <a href="{{ route('datapekerja') }}" class="menu-link">
      ...
      <li class="menu-item">
        <a href="{{ route('adminreview') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
      ...
      <li class="menu-item ">
        <a href="{{ route('adminpembayaran') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
          <div data-i18n="Analytics">Pembayaran </div>
        </a>
      </li>
      <li class="menu-item ">
        <a href="{{ route('adminlaporan') }}" class="menu-link">
          <i class="menu-icon tf-icons bx bx-home-circle"></i>
